...
# python main.py local-select --data_dir /mnt/d/IHC-found/Data --output_dir ./output_multi_full --split train  --descriptor_backend cpu --num_workers 60 --gpu_ids 0  --auto_reduce_gpu_workers  --rle_min_fraction 0.75 --local_keep_ratio 0.10 --local_keep_max 16 --semantic_weight 0.50 --interface_weight 0.30 --redundancy_weight 0.20 --nuisance_weight 0.35 >> logs_cpu_multi_60.tx6
# Stage 2
python main.py global-select --candidate_dir ./output_multi_full/candidates --output_dir ./output_multi_full/global_selection --target_size 300000 --bin_columns tissue,is_cancer,state_bin,interface_bin --bin_alpha 0.5 --data_dir /mnt/d/IHC-found/Data --export_tars --tar_num_workers 16 --tar_max_images_per_tar 8192
# Stage 3
